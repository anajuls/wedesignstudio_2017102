...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('upload', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('upload', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('uploads', function(err, result) {
      if (err) throw (err);
      ...
      result.quote.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('uploads', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('uploas', function(err, result) {
      if (err) throw (err);
      ...
      delete result.quote.section[obj.section].entree[obj.entree];
      //This is where we convert from JSON and write back our XML file
      jsToXmlFile('upload', result, function(err) {
        if (err) console.log(err);
      })
    })
  }
