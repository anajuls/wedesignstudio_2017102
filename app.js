...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Quote.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Quote.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Quote.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('Quote.xml', result, function(err) {
